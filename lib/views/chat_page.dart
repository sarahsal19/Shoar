      ...
      child: ListView(
        ...
        children: [
          _itemChat(
            ...
            chat: 0,
            message:
                'السلام عليكم ورحمة الله, مساك الله بالخير أ.رضا ',
            time: '18.00',
          ),
          _itemChat(
            chat: 0,
            message: 'عندي استفسار بخصوص الاستثمار في المنصات التقنية , هل تنصح فيه ؟ عندي سيولة مالية الحمدلله لكن محتار هل بتنمو مع الاستثمار أو لا؟',
            time: '18.03',
          ),
          _itemChat(
            avatar: 'assets/images/reda.png', 
          ...
          _itemChat(
            chat: 0,
            message:
                'ممتاز ممتاز , الله يعطيك العافية ما قصرت',
            time: '19.02',
          ),
          _itemChat(
            avatar: 'assets/images/reda.png', 
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '$time',
                style: TextStyle(color: Colors.grey.shade400, fontSize: 12),//todo: small size
              ),
            ],
          ),
        ),
